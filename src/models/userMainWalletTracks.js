...
const collectionName = 'userMainWalletTracks';

const userMainWalletTracksSchema = new Schema(
    {
...
module.exports = mongoose.model(collectionName, userMainWalletTracksSchema, collectionName);
