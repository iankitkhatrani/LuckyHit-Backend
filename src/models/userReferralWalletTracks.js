...
const collectionName = 'userReferralWalletTracks';

const userReferralWalletTracksSchema = new Schema(
    {
...
module.exports = mongoose.model(collectionName, userReferralWalletTracksSchema, collectionName);
