...
const collectionName = 'userWinWalletTracks';

const userWinWalletTracksSchema = new Schema(
    {
...
module.exports = mongoose.model(collectionName, userWinWalletTracksSchema, collectionName);
