    ...
    try {
        if (requestData.playerId !== '' && requestData.playerId !== null && requestData.playerId !== undefined) {
            ...
            if (tabInfo.gameState === "StartEviator") {
                ...
                logger.info("responseRS =>", responseRS)
                logger.info("Diffr  ", GetTimeDifference(new Date(tabInfo.aviatorDate), currentDateTime))

                logger.info("currentDateTime - turnTime ", currentDateTime, turnTime)
