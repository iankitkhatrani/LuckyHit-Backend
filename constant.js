const CONST = {
  ...
  DASHBOARD: 'DASHBOARD',
  SEND_OTP_FORGOT: 'SEND_OTP_FORGOT',
  ...
  BNW_START_BATTING_TIMER: 'BSBT',
  BNW_STOP_BATTING_TIMER: "BST",
  BNW_LEAVE_TABLE: 'BLT',
  BNW_WALLET_UPDATE: 'BWU',
  BNW_BET_COUNTEING: "BBC",
  BNW_PREVIOUS_RESULT_HISTORY: "BPRH",
  BNW_RECONNECT: 'BRE',
  BNW_GAMEPLAY: 'BLACKNWHITE',
  BNW_START_BATTING_TIMER_DELAY: 'BSTD',
